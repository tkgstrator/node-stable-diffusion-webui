...
watch(parameters, (new_value, old_value) => {
...
function restore(): void {
  ...
  if (localStorage.getItem("parameters") !== null) {
    ...
    parameters.value.prompts.positive = txt2img.prompt.split(",");
    parameters.value.prompts.negative = txt2img.negative_prompt.split(",");
  }
}
</script>
